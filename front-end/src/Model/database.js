  ...
  users: [
    {
      ...
      wallet: {
        ...
        transactions: [
          { id: "1", type: "credit", amount: 140, date: "2025-08-14", from: "Ahmed", to: "124847", etat: "valid" },
          { id: "2", type: "debit",  amount: 200, date: "2025-08-13", from: "124847", to: "Amazon",  etat: "valid" },
          { id: "3", type: "credit", amount: 250, date: "2025-08-12", from: "Ahmed", to: "124478", etat: "valid" }
        ],
        beneficiaries: [
    ...
    },
    {
      ...
      wallet: {
        ...
        transactions: [
          { id: "1", type: "credit", amount: 140, date: "2025-08-14", from: "Ali", to: "12347",  etat: "valid" },
          { id: "2", type: "debit",  amount: 200, date: "2025-08-13", from: "12347", to: "Amazon", etat: "valid" },
          { id: "3", type: "credit", amount: 250, date: "2025-08-12", from: "Ali", to: "224478", etat: "valid" }
        ],
        beneficiaries: [
...
// Obtenir les bénéficiaires d'un utilisateur par son id
export const getbeneficiaries = (id) => {
  return database.users.find((u) => u.id === id).wallet.beneficiaries;
};

// Trouver un bénéficiaire par id utilisateur et id bénéficiaire
export const findbeneficiarieByid = (id, beneficiaryId) => {
  return database.users.find((u) => u.id === id).wallet.beneficiaries.find((b) => b.id === beneficiaryId);
};

// Trouver un utilisateur par numéro de compte
